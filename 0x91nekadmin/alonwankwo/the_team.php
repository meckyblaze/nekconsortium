...
if (isset($_POST['post'])) {
	...
	move_uploaded_file($tmp_name, $loc.$pic);
			...
			$sql = "INSERT INTO the_team(name, unique_id, cv, pic, post_date)VALUES('$name', '$unique_id', '$cv', '$pic', NOW())";
					...
					<div class="col-md-6">
						<div class="panel panel-widget">
							...
							<div class="panel-body">
								...
								<div class="col-md-12">
					              <input type="text" name="name" placeholder="Enter name" style="width: 100%;" required="" /><br /><br />
					              <input type="text" name="unique_id" placeholder="unique id (e.g. 1, 2, 3, or 4)" style="width: 100%;" required="" /><br /><br />
					              <textarea placeholder="Enter staff details" rows="6" style="width: 100%;" name="cv" required="" /></textarea><br />
