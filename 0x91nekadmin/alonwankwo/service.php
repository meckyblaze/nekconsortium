...
if (isset($_POST['post'])) {
	...
	move_uploaded_file($tmp_name, $loc.$pic);
			...
			$sql = "INSERT INTO service(post_title, unique_id, post_details, pic, post_date)VALUES('$post_title', '$unique_id', '$post_details', '$pic', NOW())";
					...
					<div class="col-md-6">
						<div class="panel panel-widget">
							...
							<div class="panel-body">
								...
								<div class="col-md-12">
					              <input type="text" name="post_title" placeholder="Enter discipline, (e.g. Engineer)" style="width: 100%;" required="" /><br /><br />
					              <input type="text" name="unique_id" placeholder="unique id, (e.g. 1, 2, 3 or 4)" style="width: 100%;" required="" /><br /><br />
					              <textarea placeholder="Job description or responsibilities" rows="6" style="width: 100%;" name="post_details" required="" /></textarea><br />
