...
if (isset($_POST['post'])) {
	...
	move_uploaded_file($tmp_name, $loc.$pic);
			...
			$sql = "INSERT INTO portfolio(post_title, post_details, pic, post_date)VALUES('$post_title', '$post_details', '$pic', NOW())";
					...
					<div class="col-md-6">
						<div class="panel panel-widget">
							...
							<div class="panel-body">
								...
								<div class="col-md-12">
					              <input type="text" name="post_title" placeholder="Enter image title here" style="width: 100%;" required="" /><br /><br />
					              <textarea placeholder="Enter image details here" rows="6" style="width: 100%;" name="post_details" required="" /></textarea><br /><br /><br />
